    ...
    DisposableEffect(context) {
        val receiver = object : BroadcastReceiver() {
            ...
            override fun onReceive(ctx: Context, intent: Intent) {
                ...
                if (newQuickData != null) {
                    quickData = newQuickData
                }
                ...
                data?.let { d ->
                    ...
                    if (viewState.flash != engineFlashState || viewState.flashLevel != d.flashLevel) {
                        newViewState = newViewState.copy(flash = engineFlashState, flashLevel = d.flashLevel)
                        stateChanged = true
                    }
